...
<head>
  ...
  <style>
    ...
    <body bgcolor="red" background="2.jpg" style="background-size: cover;">
    <header>
        <nav>
          <div class="container">
            <img src="mind.jpeg" height="50px" width="80px">
            <h1>MINDFUL MOMENTUM</h1>
          </div>
          <ul>
  ...
  <div class="home">
    <h1   style="color: white;"><br>"Empowering Minds, Healing Hearts." <br> </h1> 
  ...
  <footer>
    <p>&copy; MINDFUL MOMENTUM All rights reserved.</p>
  </footer>
...
<body bgcolor="red" background="bgplans.jpg" style="background-size: cover;"> 
    <header>
        <nav>
          <div class="container">
            <img src="mind.jpeg" height="50px" width="80px">
      ...
      <div class="container1">
        <div class="product">
          <img src="group.jpeg" alt="Product 1">
          <div class="product-info">
            <div class="product-name"> Group Therapy Programs</div>
        ...
        <div class="product">
          <img src="solo.png" alt="Product 2">
          <div class="product-info">
            <div class="product-name">Individual Therapy Sessions</div>
        ...
        <div class="product">
          <img src="family.jpeg" alt="Product 3">
          <div class="product-info">
            <div class="product-name">Family Counseling Services</div>
        ...
        <div class="product">
          <img src="group.jpeg" alt="Product 4">
          <div class="product-info">
            <div class="product-name">Specialized Treatment Tracks</div>
      ...
      <footer>
        <p>&copy; MINDFULL MOMENTUM. All rights reserved.</p>
      </footer>
</body>
</html>
```
...
<body bgcolor="red" background="bgdoctors2.jpg" style="background-size: cover;">
    <header>
        <nav>
          <div class="container">
            <img src="mind.jpeg" height="50px" width="80px">
      ...
      <div class="container1">
        <div class="member">
          ...
          <div class="member-info">
            <div class="member-name">DR.Malarvizhi</div>
        ...
        <div class="member">
          <img src="shra.jpeg">
          <div class="member-info">
            <div class="member-name">DR.Mithra</div>
        
          </div>
        </div>
    
        <div class="member">
          <img src="simbran.jpeg" >
          <div class="member-info">
            <div class="member-name">DR.Mangalam</div>
        ...
        <div class="member">
          <img src="nasser.jpeg">
          <div class="member-info">
            <div class="member-name">DR.Nasser</div>
...
<body bgcolor="red" background="contact1.jpg" style="background-size: cover;">
